    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      ...
      >
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h3 className="text-2xl font-bold text-neutral-900">New Order</h3>
            <p className="text-neutral-500">Creating loan for <span className="font-semibold text-neutral-900">{customerName}</span></p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div>
                <label className="block text-sm font-semibold text-neutral-700 mb-2">Principal Amount</label>
              ...
              <div>
                <label className="block text-sm font-semibold text-neutral-700 mb-2">Interest Rate (%)</label>
                <div className="relative">
                  <input
                    type="number"
                    step="0.1"
            ...
            <div className="space-y-6">
              <div>
                <label className="block text-sm font-semibold text-neutral-700 mb-2">Term (Days)</label>
                <div className="relative">
                  <input
                    type="number"
                    required
          ...
          <div className="bg-neutral-50 rounded-2xl p-6 border border-neutral-100">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div>
                <p className="text-xs text-neutral-400 uppercase font-bold tracking-wider mb-1">Total Due</p>
                <p className="text-lg font-bold text-neutral-900">${totalDue.toLocaleString()}</p>
              </div>
            </div>
            <div className="mt-4 pt-4 border-t border-neutral-200">
              <p className="text-sm text-neutral-500">
                Due on <span className="font-bold text-neutral-900">{format(addDays(new Date(startDate), parseInt(termDays || '0')), 'MMMM do, yyyy')}</span>
              </p>
            </div>
          </div>
